...
async function generateFakeTransactions(accountId, numTransactions) {
  ...
  `;
    ...
    await connection.executeMany(insertTransactionSql, fakeTransactions);
    console.log(numTransactions, "fake transactions inserted");
    connection.commit();
}
...
async function setupDatabase() {
    ...
    await connection.execute(
        `CREATE INDEX transactions_idx ON transactions(account_id, creation_ts)`
    );
